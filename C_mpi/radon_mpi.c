...
void main(int argc, char *argv[]) 
{
    // Particles
    Particle * particles;
    int particles_num = 1024; 
    int nPathPoints = 10000;
    int gauss_kon = 1;
    double gauss_y = 0.0;
    ...
    else
    {
        ...
        while(running)
        {
            ...
            MPI_Send(partial_trajectory, 1, dt_point, 0, 0, MPI_COMM_WORLD);
        }
    }
